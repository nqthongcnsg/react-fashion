          ...
          <div className="col-md-10">
            <div className="col-md-6 grid">
              <div className="flexslider">
                ...
                <div className="row col-md-12">
                  <img
                    src={domain + "/" + img.images[1]}
                    width={190}
                    height={150}
                    className="hinh"
                  />
                  <img
                    src={domain + "/" + img.images[2]}
                    width={190}
                    height={150}
                  />
                </div>
              ...
              <div className="span_2_of_a1 simpleCart_shelfItem">
                ...
                <div className="quantity">
                  <div className="quantity-select">
                    <div className="entry value-minus" onClick={onClickDel}>
                      &nbsp;
                    </div>
            ...
            <div className="tab-head">
              ...
              {productType &&
                productType.map((item, index) => {
                  return (
                    <Similar key={item.idProduct} product={item}></Similar>
                  );
                })}
              <div className="clearfix"></div>
              <div>
              ...
              <div className="tab-content one">
                <div className="tab-pane active text-style" id="tab1">
                  <div className="facts">
                    <p>
                      {" "}
                      Có rất nhiều biến thể của các đoạn văn của Lorem Ipsum có
                      sẵn, nhưng phần lớn đã bị thay đổi dưới một số hình thức,
                      bởi sự hài hước được đưa vào hoặc các từ ngẫu nhiên trông
                      thậm chí không đáng tin một chút. Nếu bạn định sử dụng một
                      đoạn văn của Lorem Ipsum, bạn cần chắc chắn rằng không có
                      bất kỳ điều gì đáng xấu hổ ẩn ở giữa văn bản. Tất cả các
                      trình tạo Lorem Ipsum trên Internet đều có xu hướng lặp
                      lại các phần được xác định trước khi cần thiết, khiến đây
                      trở thành trình tạo thực sự đầu tiên trên Internet. Nó sử
                      dụng từ điển hơn 200 từ Latinh, được kết hợp{" "}
                    </p>
                    <ul>
                      <li>
                        <span
